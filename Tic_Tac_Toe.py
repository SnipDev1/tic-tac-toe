    ...
    while checker:
        ...
        if x_pos < -150 and y_pos > 140 and x_pos != 0 and y_pos != 0:
            ...
            if positions[0] == a:
                positions[0] = figure
                if figure == "x":
                    figures.x_figure(processing.list_to_int_x(
                        0), processing.list_to_int_y(0))
                else:
                    figures.o_figure(processing.list_to_int_x(
                        0), processing.list_to_int_y(0))
                iterat += 1
            else:
                continue
        ...
        if ("x" in positions[0:1] and "x" in positions[1:2] and "x" in positions[2:3] or
                "x" in positions[3:4] and "x" in positions[4:5] and "x" in positions[5:6] or
                "x" in positions[6:7] and "x" in positions[7:8] and "x" in positions[8:9] or
                "x" in positions[0] and "x" in positions[4] and "x" in positions[8] or
                "x" in positions[2] and "x" in positions[4] and "x" in positions[6] or
                "x" in positions[0] and "x" in positions[3] and "x" in positions[6] or
                "x" in positions[1] and "x" in positions[4] and "x" in positions[7] or
                "x" in positions[2] and "x" in positions[5] and "x" in positions[8]):
            winner = 'X'
            checker = False
        elif ("o" in positions[0:1] and "o" in positions[1:2] and "o" in positions[2:3] or
                "o" in positions[3:4] and "o" in positions[4:5] and "o" in positions[5:6] or
                "o" in positions[6:7] and "o" in positions[7:8] and "o" in positions[8:9] or
                "o" in positions[0] and "o" in positions[4] and "o" in positions[8] or
                "o" in positions[2] and "o" in positions[4] and "o" in positions[6] or
                "o" in positions[0] and "o" in positions[3] and "o" in positions[6] or
                "o" in positions[1] and "o" in positions[4] and "o" in positions[7] or
                "o" in positions[2] and "o" in positions[5] and "o" in positions[8]):
            winner = 'O'
            checker = False
        elif iterat == 9:
            checker = False
